...
export class Triangle {
    ...
    public getType(): any {
        ...
        if (this.isValid()) {
            if (this.lengthOne == this.lengthTwo && this.lengthOne == this.lengthThree) {
            ...
            } else if (this.lengthOne**2 + this.lengthTwo**2 == this.lengthThree**2) {
    ...
    public angle(angleNumber: number): number {
        ...
        if (this.isValid()) {
            switch (angleNumber) {
                case 1:
                    angle = Math.acos(
                        (this.lengthTwo**2 + this.lengthThree**2 - this.lengthOne**2)
                        / (2 * this.lengthTwo * this.lengthThree)
                    )
                    break
                case 2:
                    angle = Math.acos(
                        (this.lengthOne**2 + this.lengthThree**2 - this.lengthTwo**2)
